...
(function () {
  ...
  // anti-alias seams; the outer silhouette stays pixel-exact.
  const BODY = [15.8, 0, 84.2, 47.6];
  const ARM_L = [5.2, 16.9, 16.8, 35.8], ARM_R = [83.2, 16.9, 94.8, 35.8];
  const LEGS = [
    [15.8, 46.6, 25.5, 64.8], [33.4, 46.6, 43.1, 64.8],
    [56.9, 46.6, 66.6, 64.8], [74.5, 46.6, 84.2, 64.8],
  ];
